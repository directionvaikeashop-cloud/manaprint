# -*- coding: utf-8 -*-
"""
MANAPRINT — Générateur BG 75 (format A4)
...
Chaque carte : en-tête B | G | 75 puis grille 2 rangées × 3 colonnes —
5 BOULES triées vers le bas (décision Maeva) :
  B = 1-15 (×2) · G = 46-60 (×1, en haut) · 75 = 61-75 (×2)
...
def generer_pdf(nb_cartes=12, serie_start=1, theme="", couleur=True,
    ...
    rng = random.Random(939700 + int(serie_start))
...
if __name__ == "__main__":
    ...
    with open("test_bg75.pdf", "wb") as f:
        f.write(pdf.read())
    print("BG 75 généré")
