"""
MANAPRINT — CERF VOLANT · CLASSIC (format A4)

🌺 LE JUMEAU SANS IMAGE (sceau Maeva 15/08) : certaines clientes
préfèrent le carton d'avant, sobre, sans le dessin. Ce fichier est la
version d'ORIGINE, laissée exactement telle qu'elle était.

⚠️⚠️ NE JAMAIS Y TOUCHER quand on décore un jeu : les habillages vont
dans `cerf_volant.py`, jamais ici. C'est ce fichier qui garde la mémoire de
l'ancien carton.
"""
import io
import random
