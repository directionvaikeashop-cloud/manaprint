# -*- coding: utf-8 -*-
"""
MANAPRINT — Générateur INO 8 BOULES (format A4)
12 cartes par feuille A4 (3 colonnes × 4 rangées).
Chaque carte : en-tête I | N | O puis grille complète 3×3 — 8 numéros triés
vers le bas, la CASE CENTRALE du N restant vide (fidèle au modèle) :
  I = 16-30 (×3),  N = 31-45 (×2, rangées 1 et 3),  O = 61-75 (×3)
Le QR de vérification habite la case vide du centre — la signature INO.
...
COLONNES = [(16, 30, 3), (31, 45, 2), (61, 75, 3)]
...
def _dessiner_carte(c, x0, y0, cols_nums, couleur_hex, serie, titre_jeu="", telephone="", style="eco", evenement_id=""):
    ...
    signature = "INO 8 boules by TUKEA"
    if titre_jeu and "INO" not in titre_jeu.strip().upper():
    ...
    taille = 32  # bien gros (style Maeva)
...
def generer_pdf(nb_cartes=12, serie_start=1, theme="", couleur=True,
    ...
    rng = random.Random(931600 + int(serie_start))
