# -*- coding: utf-8 -*-
"""
MANAPRINT — Générateur BN 75 (format A4)
...
Chaque carte : en-tête B | N | 75 puis grille 2 rangées × 3 colonnes —
5 BOULES triées vers le bas (décision Maeva) :
  B = 1-15 (×2) · N = 31-45 (×1, en haut) · 75 = 61-75 (×2)
La case du BAS-MILIEU est libérée pour le QR de vérification.
Deux sauts dans le tirage : ni 16-30, ni 46-60 (caller informé) !
...
PAGE_W, PAGE_H = A4
LETTRES = ["B", "N", "75"]
COLONNES = [(1, 15), (31, 45), (61, 75)]   # ni 16-30, ni 46-60 !
...
if __name__ == "__main__":
    ...
    with open("test_bn75.pdf", "wb") as f:
        f.write(pdf.read())
    print("BN 75 généré")
