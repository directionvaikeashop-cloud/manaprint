# -*- coding: utf-8 -*-
"""
MANAPRINT — Générateur TRIPLE BG75 (format A4)
7 LANGUETTES PLEINE LARGEUR/page — les languettes TRIPLE aux zones du BG75, chiffres 32 pts (calibre POW) : le pavé-titre à gauche
(TRIPLE / BG75) et 3 GRANDES CASES, chacune avec 3 numéros TRIÉS (2 en haut,
1 en bas) : case 1 = B 1-15 · case 2 = G 46-60 · case 3 = 75 61-75.
...
NB_NUMS = 9
# les languettes TRIPLE aux zones du jeu BG75 : 3 cases de 3 numéros
# TRIÉS chacune — lecture haut-gauche, haut-droit puis bas-centre ;
# case 1 = B 1-15, case 2 = G 46-60, case 3 = 75 61-75
...
def _dessiner_carte(c, x0, y0, nums, couleur_hex, serie, titre_jeu="", telephone="", style="eco", evenement_id=""):
    ...
    # ── le pavé-titre de la languette : TRIPLE / BG75 empilés (façon modèle) ──
    ...
    c.drawCentredString(x0 + 10.5 * mm, y0 + 15.0 * mm, "BG75")
...
def generer_pdf(nb_cartes=8, serie_start=1, theme="", couleur=True,
    ...
    rng = random.Random(972000 + int(serie_start))
    ...
    for _ in range(nb_pages):
        ...
        for row in range(ROWS_PAGE):
            for col_i in range(COLS_PAGE):
                ...
                zb = sorted(rng.sample(range(46, 61), 3))  # case 2 (le G du BG75)
                zc = sorted(rng.sample(range(61, 76), 3))  # case 3 (le 75 du BG75)
                nums = za + zb + zc
