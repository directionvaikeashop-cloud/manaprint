# -*- coding: utf-8 -*-
"""
MANAPRINT — Générateur TAHAA 90 (format A4 PAYSAGE)

🐛 NÉ LE 13/08 (sceau Maeva) : LE JUMEAU DE TAHAA 75, pour le sac de 90.
« VOTRE JEU TAHAA 90 — DE 6 BOULES » : la même chenille rieuse, mais avec
SIX anneaux au lieu de cinq.

RÈGLE : six boules, une par tranche de quinze —
...
# 🐛 les SIX tranches de quinze du sac de 90
BOULES = [((1, 15), 0, 0), ((16, 30), 0, 0), ((31, 45), 0, 0),
          ((46, 60), 0, 0), ((61, 75), 0, 0), ((76, 90), 0, 0)]
...
_RATIO_CHENILLE = 2.662
ANNEAUX = [[0.3501, 0.4886], [0.4667, 0.4886], [0.5833, 0.4886], [0.6999, 0.4886], [0.8165, 0.4886], [0.9331, 0.4886]]
DIAM_AN = 0.115
import os as _os2
...
_IMAGE_CHENILLE = _choisir_image("tahaa90_chenille", _RATIO_CHENILLE)
