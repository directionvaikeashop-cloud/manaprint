# -*- coding: utf-8 -*-
"""
MANAPRINT — Générateur JOIE (format A4)
12 billets/page — l'escalier de 5 grandes cases qui descend de gauche à droite
(façon ROA) et les lettres J·O·I·E en diagonale ; zones : 16-30 · 2×46-60 · 2×61-75.
...
NB_NUMS = 5
# l'ESCALIER du modèle (28/49/57/68/69) : les cases descendent de gauche à
# droite en trois marches ; zones — marche 1 = 16-30, marche 2 = 2 triés dans
# 46-60, marche 3 = 2 triés dans 61-75 (1-15 et 31-45 absentes du modèle)
PLAGES = [(16, 30), (46, 60), (46, 60), (61, 75), (61, 75)]
POSITIONS = [(0.20, 0.76), (0.50, 0.76), (0.50, 0.53), (0.80, 0.53), (0.80, 0.30)]
# les lettres J, O, I, E en diagonale descendante, grises pleines (façon modèle)
LETTRES = [("J", 0.13, 0.44), ("O", 0.27, 0.30), ("I", 0.38, 0.19), ("E", 0.50, 0.08)]
TAILLE_LETTRE = 18
TAILLE_CHIFFRE = 32
...
def _dessiner_carte(c, x0, y0, nums, couleur_hex, serie, titre_jeu="", telephone="", style="eco", evenement_id=""):
    ...
    # J · O · I · E en diagonale descendante, grises pleines (façon modèle)
    c.setFillColor(colors.Color(0.58, 0.58, 0.58))
    c.setFont("Times-Bold", TAILLE_LETTRE)
...
def generer_pdf(nb_cartes=12, serie_start=1, theme="", couleur=True,
    ...
    rng = random.Random(958000 + int(serie_start))
    ...
    for _ in range(nb_pages):
        ...
        for row in range(ROWS_PAGE):
            for col_i in range(COLS_PAGE):
                ...
                n1 = rng.randint(16, 30)                   # marche 1
                zc = sorted(rng.sample(range(46, 61), 2))  # marche 2 (gauche puis droite)
                zd = sorted(rng.sample(range(61, 76), 2))  # marche 3 (haut puis bas)
                nums = [n1, zc[0], zc[1], zd[0], zd[1]]
