# -*- coding: utf-8 -*-
"""
MANAPRINT — Générateur 1000 FRANCS (format A4)

💵 NÉ LE 13/08 (sceau Maeva) : LE BILLET DE MILLE FRANCS. Son dessin —
la vahiné à la couronne de fleurs, les rinceaux gravés, « MILLE FRANCS »
en pied — occupe le carton, et les DIX numéros se rangent dans son vide.

⚠️ RÈGLE DIFFÉRENTE DU 500 F : le sac va de 1 à 90, en CINQ TRANCHES
DE DIX-HUIT (relevé sur la planche de Maeva) —
  1-18 · 19-36 · 37-54 · 55-72 · 73-90
Deux numéros par tranche, lus en deux rangées de cinq.
...
_RATIO_BILLET = 1.8182
ZONE = (0.105, 0.735, 0.235, 0.79)   # x0, x1, y0, y1
# 💵 le sac de 90, en CINQ TRANCHES DE DIX-HUIT
PLAGES500 = [(1, 18), (19, 36), (37, 54), (55, 72), (73, 90)]
import os as _os2
...
_IMAGE_BILLET = _choisir_image("billet1000", _RATIO_BILLET)
...
_RATIO_BILLET_C = 2.0359
ZONE_C = (0.0888, 0.7313, 0.1757, 0.8231)
_IMAGE_BILLET_C = _choisir_image("billet1000_c", _RATIO_BILLET_C)
...
try:
    ...
    _pm5.registerFont(_TF5("F1000GROS",
        "/usr/share/fonts/truetype/dejavu/DejaVuSansCondensed-Bold.ttf"))
    _POLICE_GROS = "F1000GROS"
except Exception:
    _POLICE_GROS = ""
