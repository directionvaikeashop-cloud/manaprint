...
from generators import dragon_or     # 🐉 DRAGON D'OR — création RANIHEI du 24/09
from generators import fafapiti     # 🐟 FAFAPITI — création RANIHEI du 24/09
...
JEUX_PROPRIETAIRE = {
    ...
    "dragon_or": "ranihei",           # 🐉 création RANIHEI du 24/09
    "fafapiti": "ranihei",            # 🐟 création RANIHEI du 24/09
}
...
# ⚠ 6 cartons par feuille A4 PAYSAGE : la planche de RANIHEI, 2 colonnes
#   x 3 rangees. Doit suivre COLS_PAGE x ROWS_PAGE dans generators/dragon_or.py.
_enregistrer_paire("dragon_or",     "DRAGON D'OR","\U0001f409", 6,  dragon_or.generer_pdf)
# ⚠ 6 cartons par feuille A4 PAYSAGE : la planche de RANIHEI, 2 colonnes
#   x 3 rangees. Doit suivre COLS_PAGE x ROWS_PAGE dans generators/fafapiti.py.
...
_PLAGES_CALLER = {
    ...
    "tureia_ranihei": (1, 90),
    # 🐉 DRAGON D'OR : sept bulles, sept tranches de 1 a 90.
    #    1-13 · 14-26 · 27-39 · 40-52 · 53-65 · 66-78 · 79-90
    "dragon_or": (1, 90),
    # 🐟 FAFAPITI : quatre lettres seulement — B (1-15), I (16-30),
    #    G (46-60), O (61-75). ⚠️ LE N EST MORT : la plage 31-45 ne
    #    sort JAMAIS. La liste exacte des 60 boules est plus bas,
    #    dans _BOULES_CALLER — ne pas la remplacer par (1, 75) seul.
    "fafapiti": (1, 75),
    "pol": (30, 60),
    "sun": (1, 24),
    "sun_casino": (1, 24),
...
_BOULES_CALLER = {
    ...
    "dragon_or": [n for n in range(1, 91)],
    # 🐟 FAFAPITI — 60 boules : 1 a 30 puis 46 a 75. RIEN entre 31 et 45.
    "fafapiti": [n for n in range(1, 31)] + [n for n in range(46, 76)],
}
