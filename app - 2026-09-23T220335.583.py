...
from generators import tureia       # 🐢 TUREIA — création RANIHEI du 23/09
...
JEUX_PROPRIETAIRE = {
    ...
    "tureia": "ranihei",              # 🐢 création RANIHEI du 23/09
}
...
# ⚠ 6 cartons par feuille A4 PAYSAGE : la planche de RANIHEI, 2 colonnes
#   x 3 rangees. Doit suivre COLS_PAGE x ROWS_PAGE dans generators/tureia.py.
...
_PLAGES_CALLER = {
    ...
    #    _BOULES_CALLER.
    "makemo": (16, 90),
    # 🐢 TUREIA : cinq colonnes de 2 — B (1-15), I (16-30), N (31-45),
    #    G (46-60) et le O etendu jusqu a 90 (61-90). Univers complet.
    "tureia": (1, 90),
    "pol": (30, 60),
    "sun": (1, 24),
    "sun_casino": (1, 24),
...
_BOULES_CALLER = {
    ...
    # 🐢 TUREIA — 90 boules, de 1 a 90, sans trou.
    "tureia": [n for n in range(1, 91)],
}
