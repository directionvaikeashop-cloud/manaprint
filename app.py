...
from generators import triple_bo75 as tbo75gen
...
_enregistrer_paire("triple_bo75",   "TRIPLE BO75 9 boules", "🔷", 7, tbo75gen.generer_pdf)
...
_BOULES_CALLER = {
    ...
    "triple_bo75": [n for n in range(1, 16)] + [n for n in range(46, 76)],  # TRIPLE BO75 — B, O et 75
}
